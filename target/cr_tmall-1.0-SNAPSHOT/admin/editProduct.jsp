            ...
            <div class="panel-body">
                <form class="form-horizontal" method="get" id="add-form" action="update">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="subTitle" name="product.subTitle"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="originalPrice" name="product.OPrice"
                                   placeholder="请输入原价格" value="${product.OPrice}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="nowPrice" class="col-sm-2 control-label">现价格</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nowPrice" name="product.NPrice"
                                   placeholder="请输入现价格" value="${product.NPrice}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <input name="product.category.id" value="${product.category.id}" type="hidden">
