...
<div class="container" >
    <ol class="breadcrumb">
        <li class="active">分类管理 <span style="color: #666666;font-size:10px ">${pagination.count}条结果</span></li>
    </ol>
...
<%--                <jsp:useBean id="categories" scope="request" type="java.util.List"/>--%>
                <c:forEach items="${requestScope.pagination.data}" var="c" varStatus="vs">
                    <tr>
                        <th scope="row">${c.id}</th>
                        <td>${c.recommend}</td>
                        <td>${c.name}</td>
<%--                        <td><a href="../property/list?category.id=${c.id}"><span class="glyphicon glyphicon-list-alt"></span></a></td>--%>
                        <td><a href="../product/list?category.id=${c.id}"><span class="glyphicon glyphicon-shopping-cart"></span></a></td>
