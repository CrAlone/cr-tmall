...
<section class="property">
    <div class="gallery">
        <div class="pic-border">
            <img src="${product.coverList[0].urlImage}" id="big-show">
        </div>
        <div class="pic-ls" id="pic-ls">
            <C:forEach items="${product.topList}" var="img" varStatus="vs">
                <img src="${img.urlImage}" big-image="${img.urlImage}"  class="sm-image ${vs.count == 1?'selected':''}">
            </C:forEach>
        </div>
    ...
    <div class="detail">
        ...
        <div class="price">
            <div class="sales">
                <img src="img/gouwu.png">${product.subTitle}
            </div>
            <div class="top-line">
                <span class="o-price left">价格</span>
                <span class="o-price-num">￥${product.OPrice}</span>
            </div>
            <div class="middle-line">
                <span class="s-price left">促销价</span>
                <span class="yen">￥</span><span class="s-price-num">${product.NPrice}</span>
            </div>
        </div>
        <div class="history">
        ...
        <div class="buy">
            <a href="buyOne?product.id=${product.id}" id="buy-link" class="display:none;"></a>
            <a href="addCart?product.id=${product.id}" id="cart-link" class="display:none;"></a>
