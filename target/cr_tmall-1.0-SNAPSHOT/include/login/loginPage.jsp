...
<main class="login">
    <div class="login-content">
        ...
        <span class="login-input-icon">
                ...
                <input type="text" placeholder="手机/会员名/邮箱" name="user.name" id="name" autofocus>
            </div>
            <div class="login-input">
        <span class="login-input-icon ">
                    <span class=" glyphicon glyphicon-lock"></span>
                </span>
                <input type="password" placeholder="密码" name="user.password" id="password">
