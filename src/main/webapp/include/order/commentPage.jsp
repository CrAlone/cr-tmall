...
<main class="comment">
    <div class="comment-left-jpg">
        <img src="${productImgDir}${orderItem.product.coverList[0].urlImage}">
    </div>
    <div class="comment-right-detail">
        ...
        <table class="comment-detail">
            <tr>
                ...
                <td><span class="comment-price">${orderItem.product.NPrice}</span>元</td>
            </tr>
            <tr>
                <td>配送</td>
        ...
        <div class="comment-time">
            ...
            <div class="comment-time-text">现在查看的是 您所购买商品的信息<br> 于${orderItem.createTime}下单购买了此商品</div>
        </div>
    </div>
    ...
    <div class="comment-form">
        <form class="inner-form" action="addComment" method="post">
            ...
            <table class="comment-table">
                <tr>
                    ...
                    <td class="right-col"><textarea name="comment.content"></textarea></td>
                    <input type="hidden" name="comment.product.id" value="${orderItem.product.id}">
                </tr>
            </table>
